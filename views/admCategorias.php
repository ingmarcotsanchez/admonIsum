...
<head>
  ...
  ?>
  <title>ISUM | Categorias Ticket</title>
</head>
...
<!-- Site wrapper -->
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Admón Categorias Ticket</h3>
                        </div>
                        <div class="card-body">
    ...
    <!-- /.Site warapper -->
    <?php require_once("admCategoriaModal.php"); ?>
    <?php include("modulos/js.php"); ?>
    <script type="text/javascript" src="js/admCategoria.js"></script>
</body>
</html>
<?php
  }else{
